...
namespace Surveillance_MVP.Pages.Cases.Exposures
{
    ...
    public class EditModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync(Guid? id)
        {
            ...
            CaseFriendlyId = exposure.Case?.FriendlyId ?? "";
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            {
                await LoadSelectLists();
                var caseEntity = await _context.Cases.FindAsync(Exposure.CaseId);
                CaseId = Exposure.CaseId;
            ...
            try
            {
                ...
                return RedirectToPage("/Cases/Details", new { id = Exposure.CaseId });
            }
