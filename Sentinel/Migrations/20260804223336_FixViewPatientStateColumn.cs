...
{
    /// <inheritdoc />
    public partial class FixViewPatientStateColumn : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Recreate the view with the correct State join
...
WHERE c.IsDeleted = 0 AND p.IsDeleted = 0;
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Recreate the old version (with the bug, for rollback purposes)
            migrationBuilder.Sql(@"
CREATE VIEW vw_CaseContactTasksFlattened AS
