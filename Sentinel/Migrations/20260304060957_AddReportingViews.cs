...
namespace Sentinel.Migrations
{
    ...
    public partial class AddReportingViews : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("IF OBJECT_ID('vw_ContactsListSimple', 'V') IS NOT NULL DROP VIEW vw_ContactsListSimple;");
            migrationBuilder.Sql("IF OBJECT_ID('vw_CaseContactTasksFlattened', 'V') IS NOT NULL DROP VIEW vw_CaseContactTasksFlattened;");
            migrationBuilder.Sql("IF OBJECT_ID('vw_OutbreakTasksFlattened', 'V') IS NOT NULL DROP VIEW vw_OutbreakTasksFlattened;");
            migrationBuilder.Sql("IF OBJECT_ID('vw_CaseTimelineAll', 'V') IS NOT NULL DROP VIEW vw_CaseTimelineAll;");
            migrationBuilder.Sql("IF OBJECT_ID('vw_ContactTracingMindMapNodes', 'V') IS NOT NULL DROP VIEW vw_ContactTracingMindMapNodes;");
            migrationBuilder.Sql("IF OBJECT_ID('vw_ContactTracingMindMapEdges', 'V') IS NOT NULL DROP VIEW vw_ContactTracingMindMapEdges;");
