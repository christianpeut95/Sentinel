...
namespace Sentinel.Services
{
    public interface ITaskAssignmentService
    {
        ...
        /// <summary>
        /// Allows a worker to skip their current task and get reassigned to the next one
        /// </summary>
        Task<bool> SkipTaskAsync(Guid taskId, string userId);
        ...
        /// <summary>
        /// Gets paginated unassigned interview tasks with filters
        /// </summary>
        Task<(List<CaseTask> Tasks, int TotalCount)> GetUnassignedInterviewTasksPaginatedAsync(
            int pageNumber,
            int pageSize,
            string? priority = null,
            string? searchTerm = null,
        ...
        /// <summary>
        /// Gets paginated escalated interview tasks
        /// </summary>
        Task<(List<CaseTask> Tasks, int TotalCount)> GetEscalatedInterviewTasksPaginatedAsync(
            int pageNumber,
            int pageSize,
            string? searchTerm = null);
