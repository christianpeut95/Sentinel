...
namespace Sentinel.Services
{
    ...
    public interface ITaskService
    {
        ...
        /// <summary>
        /// Auto-creates tasks for a newly created case based on disease configuration
        /// </summary>
        Task<List<CaseTask>> AutoCreateTasksForNewCase(Guid caseId);
        ...
        /// <summary>
        /// Creates a task from a template for a specific case (used by manual task creation UI)
        /// </summary>
        Task<CaseTask> CreateTaskFromTemplateForCaseAsync(Guid caseId, Guid taskTemplateId, string? assignedToUserId = null);
